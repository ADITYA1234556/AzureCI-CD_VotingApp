...
REPO_URL="https://<PersonalAccessToken>@dev.azure.com/adityanavaneethan1998/Voting-App/_git/Voting-App"
...
# sed -i "s|image:.*|image: votingappcontainers/$2:$3|g" k8s-specifications/$1-deployment.yaml
